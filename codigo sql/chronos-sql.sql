...
CREATE TABLE USUARIO_CARGO (
    LOGIN VARCHAR2(225) NOT NULL,
    ID_CARGO NUMBER NOT NULL,
    PRIMARY KEY(LOGIN, ID_CARGO),
    CONSTRAINT FK_USUARIO_CARGO_CARGO FOREIGN KEY (ID_CARGO) REFERENCES CARGO (ID_CARGO),
    CONSTRAINT FK_USUARIO_CARGO_USUARIO FOREIGN KEY (LOGIN) REFERENCES USUARIO (LOGIN)
);
...
CREATE TABLE FOTO (
 ...
 ARQUIVO BLOB,
 PRIMARY KEY (ID_FOTO),
 CONSTRAINT FK_USUARIO_FOTO FOREIGN KEY (LOGIN) REFERENCES USUARIO (LOGIN)
);
...
CREATE TABLE PROCESSO (
    ...
    ORDEM_EXECUCAO NUMBER NOT NULL,
    PROCESSO_CRITICO SMALLINT NOT NULL,
...
INSERT INTO CARGO (ID_CARGO, NOME, DESCRICAO)
VALUES (seq_cargo.nextval, 'ROLE_GESTOR', 'Coordenador'); -- 2

INSERT INTO CARGO (ID_CARGO, NOME, DESCRICAO)
VALUES (seq_cargo.nextval, 'ROLE_GESTAO_DE_PESSOAS', 'Gestão de pessoas'); -- 3

INSERT INTO CARGO (ID_CARGO, NOME, DESCRICAO)
VALUES (seq_cargo.nextval, 'ROLE_INSTRUTOR', 'Instrutor'); -- 4

INSERT INTO CARGO (ID_CARGO, NOME, DESCRICAO)
VALUES (seq_cargo.nextval, 'ROLE_ALUNO', 'Aluno'); -- 5

INSERT INTO CARGO (ID_CARGO, NOME, DESCRICAO)
VALUES (seq_cargo.nextval, 'ROLE_COLABORADOR', 'Colaborador'); -- 6
