...
public class UsuarioServiceTest {
    ...
    public void deveTestarCreateComEmailForaDoPadrao() throws RegraDeNegocioException, IOException {
        // SETUP
        String senhaCriptografada = "$oieufr9873he4j809fy43";
        UsuarioCreateDTO usuarioCreate = getUsuarioCreateDTO();
        usuarioCreate.setEmail("fulano@gmail.com");
    ...
    private static UsuarioCreateDTO getUsuarioCreateDTO() {
        ...
        usuarioCreateDTO.setEmail("luiz@dbccompany.com.br");
