...
//
//        //SETUP
//        String token = "45675678323WHSJKD";
//        UsuarioEntity usuarioEntity = getUsuarioEntity();
//        UsuarioDTO usuarioDTO = getUsuarioDTO();
//        when(usuarioRepository.findByEmail(anyString())).thenReturn(usuarioEntity);
//        when(tokenService.getToken(usuarioEntity, true)).thenReturn(token);
//
//        //ACT
//        String sla =  loginService.sendRecoverPasswordEmail(usuarioEntity.getEmail());
//
//        // ASSERT
//        assertNotNull(sla);
//
